...
await import('./validate-p3-closure-lab.mjs');
...
console.log('P3_CLOSURE_LAB=STATIC_READY_PHYSICAL_OPEN');
console.log('P3_DELETION_RESURRECTION_NEGATIVE_MATRIX=PASS');
console.log('P3_PROVIDER_ENVIRONMENT=NOT_PROVISIONED');
console.log('P3_PHYSICAL_EXECUTION=OPEN');
...
console.log('CI_ROLE=REVALIDATES_BOUND_PHYSICAL_RECEIPTS_STATIC_OPEN_BOUNDARIES_DEBT_LEDGER_P1_HARNESS_AND_P3_CLOSURE_LAB');
