...
for (const path of [
  "graph/physical-receipts/ALPHA2-R1-TRUSTED-EDGE-SIGNING-2006-2026-09-08.txt",
  "graph/physical-receipts/ALPHA2-R1-TRUSTED-EDGE-SIGNING-2006-2026-09-08.json",
  "tools/validate-alpha2-r1-physical-signing-receipt.mjs"
]) assert(workflow.includes(path), `R1 workflow must route future +2006 receipt change: ${path}`);
