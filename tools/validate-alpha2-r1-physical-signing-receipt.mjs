...
const sourcePath = 'graph/physical-receipts/ALPHA2-R1-TRUSTED-EDGE-SIGNING-2004-2026-09-08.txt';
const reducedPath = 'graph/physical-receipts/ALPHA2-R1-TRUSTED-EDGE-SIGNING-2004-2026-09-08.json';
...
const expectedStatic = {
  ...
  inputApkSha256: '14d8134bd6686291155d411e8938af632f1bba0d6ba1b94b5f86b35b13fbc1c1',
  inputApkBytes: 182091971,
...
assert(r1.status === 'TRUSTED_EDGE_SIGNING_PASS' && r1.trustedEdgeSigningPass === true, 'R1 must be closed by current +2004 receipt');
...
assert(r2.status === 'READY_FOR_PHYSICAL_CAMPAIGN', 'R2 must be ready only after current +2004 R1 PASS');
assert(r2.r1PhysicalReceipt === reducedPath, 'R2 must bind exact current +2004 R1 receipt');
