...
const contracts = {
  ...
  'alpha2-r1-trusted-edge-signing.yml': {
    markers: ['node tools/validate-alpha2-canonical-candidate.mjs','node tools/validate-alpha2-r1-signing-handoff.mjs','node tools/validate-alpha2-r1-ci-routing-receipt.mjs','node tools/validate-alpha2-r1-physical-signing-receipt.mjs','Download exact canonical +2005 artifact','Reproduce deterministic public-safe v7 handoff bundle','R1_TRUSTED_EDGE_SIGNING=PASS_FROM_SANITIZED_RECEIPT','PUBLIC_CI_ORIGINATED_PHYSICAL_PASS=0','R2_OWNED_DEVICE_CAMPAIGN=READY','PHYSICAL_ALPHA2_PASS=NO','BUILD_READY=NO','RELEASE_READY=NO'],
  ...
  'alpha2-r2-owned-device-campaign.yml': {
    markers: ['node tools/validate-alpha2-r1-physical-signing-receipt.mjs','node tools/validate-alpha2-r2-owned-device-campaign.mjs','node tools/validate-alpha2-r2-chain.mjs','node tools/validate-ci-runner-policy.mjs','R1_TRUSTED_EDGE_SIGNING=PASS_FROM_SANITIZED_RECEIPT','PUBLIC_CI_ORIGINATED_PHYSICAL_PASS=0','R2_PHYSICAL_CAMPAIGN=READY','R2_NEXT_GATE=OD0_SIGNED_APK_INSTALL_AND_LAUNCH','REAL_OAUTH_IN_CI=0','REAL_GMAIL_IN_CI=0','REAL_FINANCIAL_DATA_IN_CI=0','PRIVATE_SIGNING_MATERIAL_IN_CI=0','PHYSICAL_ALPHA2_PASS=NO','BUILD_READY=NO','RELEASE_READY=NO'],
