...
const contracts = {
  ...
  'alpha2-r2-owned-device-campaign.yml': {
    markers: [
      ...
      'OD2_METADATA_FIRST_STATEMENT_DISCOVERY=READY_FOR_PHYSICAL',
      'CURRENT_OD0_OD11_PASS=OD0_OD1',
      'ALPHA2_2006_R2_EVIDENCE=HISTORICAL_NON_INHERITABLE',
      'R2_NEXT_GATE=OD2_METADATA_FIRST_STATEMENT_DISCOVERY',
      'R2_CURRENT_BLOCKER=OD2_METADATA_FIRST_ORDERING_NOT_YET_PROVEN',
      'REAL_OAUTH_IN_CI=0','REAL_GMAIL_IN_CI=0','REAL_FINANCIAL_DATA_IN_CI=0','PRIVATE_SIGNING_MATERIAL_IN_CI=0',
      'PHYSICAL_ALPHA2_PASS=NO','BUILD_READY=NO','RELEASE_READY=NO'
    ],
    forbidden: [/PUBLIC_CI_ORIGINATED_PHYSICAL_PASS=1|OD2_METADATA_FIRST_STATEMENT_DISCOVERY=PASS|R2_PHYSICAL_CAMPAIGN=PASS|REAL_OAUTH_IN_CI=1|REAL_GMAIL_IN_CI=1|REAL_FINANCIAL_DATA_IN_CI=1|PRIVATE_SIGNING_MATERIAL_IN_CI=1|PHYSICAL_ALPHA2_PASS=YES|BUILD_READY=YES|RELEASE_READY=YES/i],
  },
};
...
console.log('R2_CURRENT_PHYSICAL_CAMPAIGN=IN_PROGRESS_OD0_OD1_PASS');
