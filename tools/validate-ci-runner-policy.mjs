...
const contracts = {
  ...
  'alpha2-r1-trusted-edge-signing.yml': {
    ...
    forbidden: [/node tools\/validate-alpha2-r1-physical-signing-receipt\.mjs|R1_TRUSTED_EDGE_SIGNING=PASS_FROM_SANITIZED_RECEIPT|R2_OWNED_DEVICE_CAMPAIGN=READY|PUBLIC_CI_ORIGINATED_PHYSICAL_PASS=1|PHYSICAL_ALPHA2_PASS=YES|BUILD_READY=YES|RELEASE_READY=YES|REAL_OAUTH_EXECUTED_BY_CI=YES|REAL_GMAIL_EXECUTED_BY_CI=YES/i],
  },
...
console.log('R1_CURRENT_PHYSICAL_RECEIPT=OPEN');
