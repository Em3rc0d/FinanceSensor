...
const contracts = {
  ...
  'alpha2-integrated-runtime.yml': {
    markers:['node tools/validate-alpha2-integrated-runtime.mjs','node tools/validate-alpha2-2010-candidate-cut.mjs','--target lib/main_alpha2.dart','--build-number 2010','CANDIDATE_ID=0.2.0-alpha.2+2010','PREDECESSOR_CANONICAL=0.2.0-alpha.2+2009','BCP_FRAGMENTED_HEADER_RECONSTRUCTION=YES','PROFILE_KEY_SESSION_REUSE=YES','PROFILE_KEY_DISK_PERSISTENCE=NO','POST_PASSWORD_SAFE_STOP_DIAGNOSTICS=YES','POST_PASSWORD_IMPORT_ISOLATION=YES','STATEMENT_FAILURE_BLOCKS_SAFE_PROJECTION=NO','ANDROID_COMPILE_SDK=37','ANDROID_MIN_SDK=31','ANDROID_TARGET_SDK=36','SQLCIPHER_VERSION=4.18.0','REAL_OAUTH_EXECUTED_BY_CI=NO','REAL_GMAIL_EXECUTED_BY_CI=NO','REAL_FINANCIAL_DATA_IN_CI=NO','PHYSICAL_SQLCIPHER_PASS=NO','PHYSICAL_ALPHA2_PASS=NO','BUILD_READY=NO','RELEASE_READY=NO'],
    forbidden:[/--build-number 2009|CANDIDATE_ID=0\.2\.0-alpha\.2\+2009\s*$|REAL_OAUTH_EXECUTED_BY_CI=YES|REAL_GMAIL_EXECUTED_BY_CI=YES|REAL_FINANCIAL_DATA_IN_CI=YES|PHYSICAL_SQLCIPHER_PASS=YES|PHYSICAL_ALPHA2_PASS=YES|BUILD_READY=YES|RELEASE_READY=YES/im]
  },
  'alpha2-r1-trusted-edge-signing.yml': {
    markers:[
      'node tools/validate-alpha2-human-intervention-gate.mjs','node tools/validate-alpha2-canonical-candidate.mjs','node tools/validate-alpha2-r1-signing-handoff.mjs','node tools/validate-alpha2-r1-ci-routing-receipt.mjs',
      'Download exact canonical +2009 artifact','financesensor-alpha2-2009-candidate-34913707304','Generate deterministic public-safe v11 handoff bundle','FinanceSensor-ALPHA2-R1-TRUSTED-EDGE-BUNDLE-v11.zip','1603ebdb5bd47bf732a1ea3cced705ac67ec57b690b1bf6795f543230e3d0717',
      'R1_V11_GENERATION=PASS','R1_V11_FROZEN_BYTES=PASS','R1_TRUSTED_EDGE_SIGNING=PASS_FROM_SANITIZED_RECEIPT','STABLE_SIGNED_APK_SHA256=7da560b9382dce0e7ee9100e923a68dc54209934c02554cf70b4c07985f0458a','OWNED_DEVICE_UAT_REQUEST_ALLOWED=YES','PUBLIC_CI_ORIGINATED_PHYSICAL_PASS=0','R2_PHYSICAL_CAMPAIGN=READY_FOR_CONSOLIDATED_UAT','PHYSICAL_ALPHA2_PASS=NO','BUILD_READY=NO','RELEASE_READY=NO'
    ],
  ...
  'alpha2-od0-owned-device-harness.yml': {
    markers:[
      'node tools/validate-alpha2-od0-owned-device-harness.mjs','node tools/validate-ci-runner-policy.mjs','ALPHA2_OD0_HANDOFF_PACKAGE=READY','CANDIDATE=0.2.0-alpha.2+2009','R1_TRUSTED_EDGE_SIGNING=PASS_FROM_SANITIZED_RECEIPT','STABLE_SIGNED_APK_SHA256=7da560b9382dce0e7ee9100e923a68dc54209934c02554cf70b4c07985f0458a','OD0_EXECUTION_ALLOWED=YES','OWNED_DEVICE_UAT_REQUEST_ALLOWED=YES','PUBLIC_CI_ORIGINATED_OD0_PASS=0','R2_NEXT_GATE=CONSOLIDATED_OWNED_DEVICE_UAT','ADB_EXECUTED_BY_CI=0','DEVICE_TOUCHED_BY_CI=0','FINANCIAL_VIEW_MATERIALIZATION=PHYSICAL_CERTIFICATION_REQUIRED','PHYSICAL_ALPHA2_PASS=NO','BUILD_READY=NO','RELEASE_READY=NO'
    ],
...
console.log('ALPHA2_2010_CANDIDATE_CUT=ROUTED');
console.log('R1_2009_TRUSTED_EDGE_STATE=PRESERVED_UNTIL_2010_PROMOTION');
