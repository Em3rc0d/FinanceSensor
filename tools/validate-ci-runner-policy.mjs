...
const contracts = {
  ...
  'alpha2-integrated-runtime.yml': {
    markers:['node tools/validate-alpha2-integrated-runtime.mjs','node tools/validate-alpha2-2011-candidate-cut.mjs','--target lib/main_alpha2.dart','--build-number 2011','CANDIDATE_ID=0.2.0-alpha.2+2011','PREDECESSOR_INTERNAL_CANDIDATE=0.2.0-alpha.2+2010','PREDECESSOR_CANONICAL=0.2.0-alpha.2+2009','BCP_FRAGMENTED_HEADER_RECONSTRUCTION=YES','BCP_SAVINGS_COMPLETENESS_VERSION=A2_BCP_SAVINGS_COMPLETENESS_V2','CERTIFIED_BCP_SUMMARY_ROWS_ARE_NOT_MOVEMENTS=YES','UNKNOWN_UNDATED_MONETARY_ROW_FAILS_CLOSED=YES','PROFILE_KEY_SESSION_REUSE=YES','PROFILE_KEY_DISK_PERSISTENCE=NO','POST_PASSWORD_SAFE_STOP_DIAGNOSTICS=YES','POST_PASSWORD_IMPORT_ISOLATION=YES','STATEMENT_FAILURE_BLOCKS_SAFE_PROJECTION=NO','ANDROID_COMPILE_SDK=37','ANDROID_MIN_SDK=31','ANDROID_TARGET_SDK=36','SQLCIPHER_VERSION=4.18.0','REAL_OAUTH_EXECUTED_BY_CI=NO','REAL_GMAIL_EXECUTED_BY_CI=NO','REAL_FINANCIAL_DATA_IN_CI=NO','PHYSICAL_SQLCIPHER_PASS=NO','PHYSICAL_ALPHA2_PASS=NO','BUILD_READY=NO','RELEASE_READY=NO'],
    forbidden:[/--build-number 2010|CANDIDATE_ID=0\.2\.0-alpha\.2\+2010\s*$|REAL_OAUTH_EXECUTED_BY_CI=YES|REAL_GMAIL_EXECUTED_BY_CI=YES|REAL_FINANCIAL_DATA_IN_CI=YES|PHYSICAL_SQLCIPHER_PASS=YES|PHYSICAL_ALPHA2_PASS=YES|BUILD_READY=YES|RELEASE_READY=YES/im]
  },
...
console.log('ALPHA2_2011_CANDIDATE_CUT=ROUTED');
console.log('R1_2009_TRUSTED_EDGE_STATE=PRESERVED_UNTIL_2011_PROMOTION');
