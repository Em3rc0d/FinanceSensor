...
const contracts = {
  ...
  'alpha2-r2-owned-device-campaign.yml': {
    markers: ['node tools/validate-alpha2-r1-physical-signing-receipt.mjs','node tools/validate-alpha2-r2-owned-device-campaign.mjs','node tools/validate-alpha2-r2-chain.mjs','node tools/validate-ci-runner-policy.mjs','R1_TRUSTED_EDGE_SIGNING=PASS_FROM_SANITIZED_RECEIPT','PUBLIC_CI_ORIGINATED_PHYSICAL_PASS=0','R2_PHYSICAL_CAMPAIGN=IN_PROGRESS','OD0_INSTALL_AND_LAUNCH=PASS_FROM_SANITIZED_PHYSICAL_RECEIPT','R2_NEXT_GATE=OD1_EXACT_GMAIL_READONLY_OAUTH','REAL_OAUTH_IN_CI=0','REAL_GMAIL_IN_CI=0','REAL_FINANCIAL_DATA_IN_CI=0','PRIVATE_SIGNING_MATERIAL_IN_CI=0','PHYSICAL_ALPHA2_PASS=NO','BUILD_READY=NO','RELEASE_READY=NO'],
