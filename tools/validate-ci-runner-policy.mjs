...
const contracts = {
  ...
  'alpha2-r2-owned-device-campaign.yml': {
    markers: [
      ...
      'R2_CURRENT_BLOCKER=OD0_INSTALL_AND_LAUNCH_NOT_YET_OBSERVED',
      'REAL_OAUTH_IN_CI=0','REAL_GMAIL_IN_CI=0','REAL_FINANCIAL_DATA_IN_CI=0','PRIVATE_SIGNING_MATERIAL_IN_CI=0',
      'PHYSICAL_ALPHA2_PASS=NO','BUILD_READY=NO','RELEASE_READY=NO'
    ],
    forbidden: [/PUBLIC_CI_ORIGINATED_PHYSICAL_PASS=1|R2_PHYSICAL_CAMPAIGN=IN_PROGRESS|OD0_INSTALL_AND_LAUNCH=PASS_FROM_SANITIZED_PHYSICAL_RECEIPT|R2_PHYSICAL_CAMPAIGN=PASS|REAL_OAUTH_IN_CI=1|REAL_GMAIL_IN_CI=1|REAL_FINANCIAL_DATA_IN_CI=1|PRIVATE_SIGNING_MATERIAL_IN_CI=1|PHYSICAL_ALPHA2_PASS=YES|BUILD_READY=YES|RELEASE_READY=YES/i],
  },
};
...
console.log('R2_CURRENT_PHYSICAL_CAMPAIGN=READY_OD0');
