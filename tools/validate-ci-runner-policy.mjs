...
const contracts = {
  ...
  'alpha2-r2-owned-device-campaign.yml': {
    markers: [
      ...
      'OD1_EXACT_GMAIL_READONLY_OAUTH=READY_FOR_PHYSICAL',
      'CURRENT_OD0_OD11_PASS=OD0_ONLY',
      'ALPHA2_2006_R2_EVIDENCE=HISTORICAL_NON_INHERITABLE',
      'R2_NEXT_GATE=OD1_EXACT_GMAIL_READONLY_OAUTH',
      'R2_CURRENT_BLOCKER=OD1_FRESH_OAUTH_NOT_YET_OBSERVED',
      'REAL_OAUTH_IN_CI=0','REAL_GMAIL_IN_CI=0','REAL_FINANCIAL_DATA_IN_CI=0','PRIVATE_SIGNING_MATERIAL_IN_CI=0',
      'PHYSICAL_ALPHA2_PASS=NO','BUILD_READY=NO','RELEASE_READY=NO'
    ],
    forbidden: [/PUBLIC_CI_ORIGINATED_PHYSICAL_PASS=1|OD1_EXACT_GMAIL_READONLY_OAUTH=PASS|R2_PHYSICAL_CAMPAIGN=PASS|REAL_OAUTH_IN_CI=1|REAL_GMAIL_IN_CI=1|REAL_FINANCIAL_DATA_IN_CI=1|PRIVATE_SIGNING_MATERIAL_IN_CI=1|PHYSICAL_ALPHA2_PASS=YES|BUILD_READY=YES|RELEASE_READY=YES/i],
  },
};
...
console.log('R2_CURRENT_PHYSICAL_CAMPAIGN=IN_PROGRESS_OD0_PASS');
