...
if (r1.trustedEdgeSigningPass !== false || r1.physicalReceipt !== null || r1.signedApkSha256 !== null || r1.signedApkBytes !== null) throw new Error('R1 may not inherit +2003 signing PASS into +2004');
if (r2.status !== 'BLOCKED_BY_R1_SIGNING' || r2.currentState?.r2PhysicalCampaign !== 'BLOCKED_BY_R1') throw new Error('R2 must remain blocked until +2004 R1 trusted-edge signing PASS');
