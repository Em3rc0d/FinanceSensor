...
const BCP_CARD_LEDGER = 'Estado de Cuenta Tarjeta VISA Fecha de proceso Fecha de consumo Descripción Tipo de Operación Soles Dólares';
const BCP_CARD_SUMMARY = 'Estado de Cuenta Tarjeta VISA MONTO TOTAL FACTURADO ¿COMO ESTA COMPUESTA SU DEUDA?';
const BCP_CARD_EDU = 'Conoce el estado de cuenta de tu Tarjeta de Crédito (Montos referenciales)';
const RIPLEY_LEDGER = 'EECC Tarjeta de Crédito Ripley Tus movimientos del mes Fecha de operación Fecha de proceso Nº Ticket Descripción T/A Monto';
...
test('BCP credit separates ledger, debt summary and educational reference', () => {
