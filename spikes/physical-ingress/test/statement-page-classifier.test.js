...
const BCP_CARD_LEDGER_FRAGMENTED = 'Fecha de proceso Fecha de consumo Descripción Tipo de Operación Soles Dólares 27 Jul 26 Jul COMERCIO DEMO CONSUMO 10.00';
...
test('BCP credit ledger role tolerates pdf.js whitespace inside DDMMM and continuation pages without repeated title', () => {
  assert.equal(
    classifyStatementPage({ text: BCP_CARD_LEDGER_FRAGMENTED, providerProfile: StatementProviderProfile.BCP_CREDIT }),
